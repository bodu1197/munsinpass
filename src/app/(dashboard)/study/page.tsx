...
import { IconBook, IconBookmark, IconCalendar, IconCards, IconChart, IconChecklist, IconChevronRight, IconFileText, IconPencil, IconRefresh, IconSearch, SUBJECT_ICON } from '@/components/icons'
    ...
    <div className="py-6">
      ...
      <div className="flex flex-wrap gap-2 mb-5">
        {[
          ...
          { href: '/study/planner', label: '플래너', Icon: IconCalendar },
          { href: '/study/glossary', label: '용어', Icon: IconBook },
